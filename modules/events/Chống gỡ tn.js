...
module.exports.handleEvent = async function({
	...
	if ((void 0 === i.resend || 0 != i.resend) && l != global.data.botID && ("message_unsend" != e.type && global.logMessage.set(g, {
		...
		if (null == m.attachment[0]) return a.sendMessage(`${e} 𝗕𝗮̣𝗻 𝗧𝘂𝗼̂̉𝗶 𝗟 𝗠𝗮̀ 𝗚𝗼̛̃ 𝗡𝗵𝗮 :)\n𝗡𝗵𝗮̆́𝗺 𝗡𝗵𝗮𝗻𝗵 𝗕𝗮̆̀𝗻𝗴 𝗕𝗼̂́ 𝗧𝗵𝗶̀ 𝗛𝗮̃𝘆 𝗚𝗼̛̃\n\n👻──── •💜• ────👻\nNội dung: ${m.msgBody}`, u); {
			let t = 0,
				s = {
					body: `${e} vừa gỡ ${m.attachment.length} 𝗧𝗲̣̂𝗽 𝗚𝗮̆́𝗻 𝗞𝗲̀𝗺.\n👻──── •💜• ────👻\n𝑵𝒐̛𝒊 𝑵𝒂̀𝒐 𝑲𝒉𝒐́ 𝑵𝒐̛𝒊 𝑨̂́𝒚 𝑪𝒐́ 𝑩𝒐𝒕 .${""!=m.msgBody?`\n\nNội dung: ${m.msgBody}`:""}`,
					attachment: [],
					mentions: {
						tag: e,
						id: l
