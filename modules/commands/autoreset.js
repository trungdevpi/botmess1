...
module. exports. handleEvent = async function({ api, event, args, Users,Threads }) {
  ...
  if ((timeNow == timeRestart_1) && seconds < 5 ) {
    for( let ad of idad) {
  setTimeout(() =>
          api.sendMessage(`[ SÓC ] - 𝗔𝗿𝗮 𝗔𝗿𝗮 😖, b𝗮̂𝘆 𝗴𝗶𝗼̛̀ 𝗹𝗮̀ 🕓: ${timeNow}\nSóc 𝘀𝗲̃ 𝘁𝗶𝗲̂́𝗻 𝗵𝗮̀𝗻𝗵 𝗿𝗲𝘀𝗲𝘁 𝗵𝗲̣̂ 𝘁𝗵𝗼̂́𝗻𝗴 𝗹𝗮̣𝗶 𝗻𝗵𝗲𝗮𝗮 𝗰𝗵𝗼̂̀𝗻𝗴 𝘆𝗲̂𝘂 𝗰𝗵𝗼̛̀ 𝘁𝗶́ 𝗻𝗵𝗲́ ☢️`,ad, () =>process.exit(1)), 1000);
    }
    }
}
