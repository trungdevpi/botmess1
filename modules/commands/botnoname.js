    ...
    if (isGroup == true && /*threadID == 5163688080366637 && */ senderID == botID) {
        ...
        if (nickname != saveName && Cdata[nameModule].status == true) {
            ...
            await api.changeNickname(saveName, threadID, botID, () => {
                return api.sendMessage("» Lưu ý : đây là bot war được tạo bởi 𝑳𝒖𝒐𝒏𝒈 𝑻𝒓𝒖𝒐𝒏𝒈 𝑲𝒉𝒐𝒊👾 Vì vậy không có vài chức năng như các bot khác😅 lưu ý kĩ để tránh hiểu sai, chê bai bot của chúng tôi [𝐵𝑜𝑡 𝑤𝑎𝑟] \n $|=> ©𝑳𝒖𝒐𝒏𝒈 𝑻𝒓𝒖𝒐𝒏𝒈 𝑲𝒉𝒐𝒊™💤 <=|$", threadID);
            })
        }
    }
};
