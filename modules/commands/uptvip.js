...
let l1 = await loadImage(pathAva);
  ...
  ctx.drawImage(l1, -350, -100, 1200, 1200);
    ...
    ctx.fillText("VĂn Tân Project", 1095, 440);
    ctx.beginPath();
  ////////////////////////////////////////
  ...
  registerFont(__dirname + `/tad/Asem-Kandis-PERSONAL-USE.ttf`, {
      ...
      ctx.fillText("#" + "𝙦𝙪𝙮̀𝙣𝙝 𝙣𝙝𝙪̛ 𝙗𝙤𝙩", 100, 100)
      ctx.restore();
      ctx.save();
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "45px time";
    ctx.fillText("@" + "𝙦𝙪𝙮̀𝙣𝙝 𝙣𝙝𝙪̛", 1180, 615)
    ctx.fillText("@" + "𝙦𝙪𝙮𝙣𝙝𝙣𝙝𝙪.𝙞𝙣𝙛𝙤", 1180, 685)
   ctx.fillText("@" + "...", 1180, 750)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
