...
module.exports.run = async function({ api, event, Currencies }) {
    ...
    if (listThreadBanned.includes(threadID)) return api.sendMessage('Bạn không được phép chơi MiniGame ở box chính, vui lòng gửi "/soccobac" và chọn box cờ bạc muốn vào.', threadID, messageID);
