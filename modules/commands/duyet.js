...
module.exports.onLoad = () => {
  ...
  if (!fs.existsSync(dirMaterial + "https://i.imgur.com/7D2AZhm.png")) request("https://i.imgur.com/7D2AZhm.png").pipe(fs.createWriteStream(dirMaterial + "biaadmin.png"));
